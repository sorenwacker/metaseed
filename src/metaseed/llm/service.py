"""LLM-powered metadata assistant implementation.

Provides an assistant that helps users fill in metadata according to profile
schemas. It can be used by any UI (hub, CLI, etc.) that needs intelligent
metadata assistance. The public entry point is re-exported from
:mod:`metaseed.llm`.
"""
